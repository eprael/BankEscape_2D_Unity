...
namespace Platformer.Mechanics
{
    ...
    public class ScoreController : MonoBehaviour
    {
        ...
        public Sprite[] lootSprites; // loot images 
        [Range(0, 10)]
        public int selectedSpriteIndex = 0; 
        public int lootValue = 25; // How much $$$ this gives
        ...
        public bool useVariableValues = true;
        public int[] lootValues; // different sprites to give different amounts
        ...
        void UpdateSprite()
        {
            if (lootSprites.Length > 0 && selectedSpriteIndex < lootSprites.Length)
            {
                spriteRenderer.sprite = lootSprites[selectedSpriteIndex];

                if (useVariableValues && lootValues.Length > selectedSpriteIndex)
                {
                    lootValue = lootValues[selectedSpriteIndex];
                }
            }
        }
        ...
        void OnValidate()
        {
            ...
            {
                selectedSpriteIndex = Mathf.Clamp(selectedSpriteIndex, 0, lootSprites.Length - 1);
